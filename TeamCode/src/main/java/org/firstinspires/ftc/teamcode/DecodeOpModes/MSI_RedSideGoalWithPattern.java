...
public final class MSI_RedSideGoalWithPattern extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action thirdCycle = drive.actionBuilder(drive.localizer.getPose())
                .splineToSplineHeading(new Pose2d(22,17.3, Math.toRadians(90)), Math.toRadians(90))
                .afterDisp(0, ()->
                        Actions.runBlocking(
                                new ParallelAction(
                                        hammer.left()
                ...
                .lineToYLinearHeading(36, Math.toRadians(90), new TranslationalVelConstraint(10.0))
