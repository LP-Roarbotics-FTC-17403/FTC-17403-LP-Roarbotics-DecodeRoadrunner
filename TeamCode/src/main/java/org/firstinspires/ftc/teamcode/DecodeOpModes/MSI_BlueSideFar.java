...
public final class MSI_BlueSideFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        beginPose                = new Pose2d(0, 0, Math.toRadians(195));
        ...
        Action fullCycleTest = drive.actionBuilder(beginPose)
                ...
                .strafeToLinearHeading(new Vector2d(-2 ,-40), Math.toRadians(195))
                .build();
